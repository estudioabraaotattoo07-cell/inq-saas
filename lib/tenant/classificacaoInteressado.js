...
//
// Definição de produto confirmada (2026-08-15, ADENDO 3 do documento acima):
// "lead quente" é o conceito comercial; "Projeto detalhado" é a sua
// apresentação visual no CRM -- esta função É a fonte de verdade de ambos.
// Mantida como função pura de propósito: quando a integração com a API de
// Conversões da Meta for planejada (não implementada ainda), esta mesma
// função poderá ser reaproveitada dentro do backend (api/lead.js), sem
// duplicar a regra -- por isso ela nunca deve passar a depender de banco,
// de tela ou de qualquer coisa que só exista no navegador.
//
