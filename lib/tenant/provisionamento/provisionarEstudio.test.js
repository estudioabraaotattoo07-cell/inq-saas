...
test("integração: sem terceiro parâmetro, usa o registro real (DOMINIOS_ATIVOS) e executa os dois domínios congelados de ponta a ponta", async () => {
  ...
  // Confirma que criarIdentidade/criarLicenciamento continuam com a mesma
  // assinatura que o registro espera (documentação viva do contrato).
