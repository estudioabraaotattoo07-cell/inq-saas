...
test("integração: sem terceiro parâmetro, usa o registro real (DOMINIOS_ATIVOS) e executa os quatro domínios congelados de ponta a ponta", async () => {
  ...
  assert.equal(relatorio.etapas.length, 4);
  ...
  // continuam com a mesma assinatura que o registro espera (documentação
  // viva do contrato).
